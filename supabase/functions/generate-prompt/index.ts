...
If the user seems down, be understanding and validating. If they're excited, match their energy. Always keep it real.`;
    ...
    const openaiApiKey = "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";
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      headers: {
        ...
        'OpenAI-Organization': 'org-XQaYCCKBcAWrpgLcoAeNrqSb', // Add the organization ID if needed
        'OpenAI-Beta': 'assistants=v2', // Include this if using the latest beta features
      },
      body: JSON.stringify({
        model: 'gpt-4o-mini',
        messages: [
